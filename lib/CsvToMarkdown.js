(function (global, factory) {
    ...
    function csvToMarkdown(csvContent, delimiter = "\t", hasHeader = false, options = {}) {
        const { newlineReplacement = CsvToMarkdownOptionsDefaults.newlineReplacement, cellFilter = CsvToMarkdownOptionsDefaults.cellFilter, prettyPrint = CsvToMarkdownOptionsDefaults.prettyPrint, } = {
